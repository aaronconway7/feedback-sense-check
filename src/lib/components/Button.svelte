...
<button on:click type="button" class="flex justify-between w-96 text-left border-4 border-solid transition { variants[variant] } { size=="large" ? 'px-5 py-3' : 'px-4 py-1'}">{label}
  {#if showArrow}
